...
-- 4
 ...
 -- 6
 select sum(tr.track_length),track_album_id,al.album_title from albums al,tracks tr
 where al.album_year and al.album_year between 1990 and 1999 and al.album_id=tr.track_album_id
  group by tr.track_album_id HAVING count(track_id)>=10;
...
select ar1.nationality,ar2.nationality,al1.album_title as Higher ,al1.album_rating, al2.album_title as Lower,al2.album_rating
...
where ar1.nationality<>ar2.nationality AND ar2.artist_name!=ar1.artist_name and al1.album_year=al2.album_year and al1.album_rating >al2.album_rating;
